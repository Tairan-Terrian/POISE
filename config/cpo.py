...
def geneval_sd3():
    ...
    # sd3.5 medium
    config.pretrained.model = "model/SD3"
    config.sample.num_steps = 10
    config.sample.eval_num_steps = 40
    config.sample.guidance_scale = 4.5
    ...
    # config.lora_path = "/mnt/afs/intern/fangwenhan/htr/flow_grpo/logs/geneval/sd3.5-M/checkpoints/checkpoint-600/lora"
...
def unifiedreward_sd3_1gpu_fast(): # <--- 修改点: 函数名
    gpu_number = 1
    config = compressibility()
    config.dataset = os.path.join(os.getcwd(), "dataset/ocr")
